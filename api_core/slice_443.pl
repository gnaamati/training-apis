...
my $slice         = $slice_adaptor->fetch_by_region('toplevel','v443_0217');
...
my $sub_slice = $slice->sub_Slice(133372,140925);
...
my $slice         = $slice_adaptor->fetch_by_region('toplevel','TGACv1_scaffold_222745_3B');
...
my $sub_slice = $slice->sub_Slice(13707,21260,-1);
